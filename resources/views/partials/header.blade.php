<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form class="navbar-form navbar-left seach-form" action="#">
          <div class="form-group">
            <input type="text" class="form-control input-sm" id="search_form" placeholder="Search">
          </div>
          <button type="submit" class="btn btn-sm btn-success">Search Product</button>
        </form> 
 ...
 Product Management <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="{{ route('admin.category') }}">Create Categorey</a></li>
                <li><a href="{{ route('admin.createProduct') }}">Create Product</a></li>  
              </ul>
            </li>
 ...
 User Management <span class="caret"></span></a>
          <ul class="dropdown-menu">
            @if(Auth::check())
              ...
              <li><a href="{{ route('user.signout')}}">Log Out</a></li>  
              @else
